...
import (
	...
	"github.com/aegis-dec/polygon-edge/command/peers/add"
	"github.com/aegis-dec/polygon-edge/command/peers/list"
	"github.com/aegis-dec/polygon-edge/command/peers/status"
